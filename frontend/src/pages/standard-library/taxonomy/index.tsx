import { Button, Col, Form, Input, InputNumber, Modal, Row, Space, Spin, Table, Typography, Upload, message } from 'antd'
...
function TaxonomyTreePanel({ nodes, expanded, toggle, hoverKey, setHoverKey, onEdit, onDelete }: TreePanelProps) {
        ...
        <Col>
          <Space size={16} wrap>
            <Button
              ...
              onClick={() => void handleDownloadTaxonomyTableTemplate()}
              style={{
                height: 42,
                paddingLeft: 22,
                paddingRight: 22,
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <Space size={6} style={{ marginTop: 10 }}>
                  ...
                  <Button
                    ...
                    onClick={() => void loadIndustryTrees()}
                  >
                    刷新
                  </Button>
                </Space>
            ...
            <Spin spinning={treeLoading}>
              {displayTree.length === 0 && !treeLoading ? (
                <div style={{ padding: 48, textAlign: 'center' }}>
                  <Text type="secondary">暂无分类数据，请确认后端已导入或稍后刷新。</Text>
                </div>
              ) : (
                <TaxonomyTreePanel
                  nodes={displayTree}
