import { Button, Col, Input, Row, Space, Table, Tooltip, Typography, Upload, message } from 'antd'
      ...
      <Space direction="vertical" size={40} style={{ ...canvasBlock }}>
        ...
        <section style={canvasBlock}>
          ...
          >
            ...
            >
              <style>{`
                .body-ingest-dropzone:hover { border-color: rgba(0,40,84,0.35) !important; }
              `}</style>
              <div
                style={{
                  width: 80,
              ...
              >
                支持 PDF、DOCX、ZIP 等格式的国标相关文件；单文件建议不超过 100MB。加入队列后可在列表中管理；正式提交工作流待与后端联调后接入。
              </Text>
            </div>
          </Upload.Dragger>
          <Space wrap style={{ marginTop: 14, width: '100%' }}>
            <Text type="secondary" style={{ fontSize: 12 }}>
              约定接口：<Text code>POST /api/workflow/standard-body-ingest/</Text>
            </Text>
          </Space>
        </section>
